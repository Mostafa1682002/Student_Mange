...
$student = $connection->query("select * from student where stu_id=$id");
$student = $student->fetch(PDO::FETCH_ASSOC);

$stu_id1 = $student['stu_id'];
$stu_name1 = $student['stu_name'];
$stu_email1 = $student['stu_email'];
$stu_phone1 = $student['stu_phone'];
$stu_date_birth1 = $student['stu_date_birth'];
$stu_depart1 = $student['stu_depart'];
$stu_skills1 = explode(',', $student['stu_skills']);
$stu_imge1 = $student['stu_imge'];


if (isset($_POST['updateStu'])) {
    $stu_id = $_POST['stu_id'];
    $stu_name = ucwords(strtolower(filter_var($_POST['stu_name'], FILTER_SANITIZE_STRING)));
    ...
    if (empty($Error)) {
        if (!empty($stu_date_birth) && !empty($_FILES['stu_imge']['name'])) {
            $res = $connection->query("UPDATE`student`SET `stu_id`=$stu_id, `stu_name`='$stu_name', `stu_email`='$stu_email', `stu_phone`='$stu_phone', `stu_date_birth`='$stu_date_birth', `stu_depart`=$stu_depart, `stu_skills`='$fstu_skills',`stu_imge`='$imgename' WHERE stu_id=$id");
            unlink("uplode/imges/$stu_imge1");
            move_uploaded_file($stu_imge, $to);
        } elseif (empty($stu_date_birth) && !empty($_FILES['stu_imge']['name'])) {
            $res = $connection->query("UPDATE student SET `stu_id`=$stu_id, `stu_name`='$stu_name', `stu_email`='$stu_email', `stu_phone`='$stu_phone', `stu_depart`=$stu_depart, `stu_skills`='$fstu_skills',`stu_imge`='$imgename' WHERE stu_id=$id;");
            unlink("uplode/imges/$stu_imge1");
            move_uploaded_file($stu_imge, $to);
        } elseif (!empty($stu_date_birth) && empty($_FILES['stu_imge']['name'])) {
            $res = $connection->query("UPDATE`student`  SET `stu_id`=$stu_id, `stu_name`='$stu_name', `stu_email`='$stu_email', `stu_phone`='$stu_phone', `stu_date_birth`='$stu_date_birth', `stu_depart`=$stu_depart, `stu_skills`='$fstu_skills' WHERE stu_id=$id;");
        } else {
            $res = $connection->query("UPDATE`student`  SET `stu_id`=$stu_id, `stu_name`='$stu_name', `stu_email`='$stu_email', `stu_phone`='$stu_phone',  `stu_depart`=$stu_depart, `stu_skills`='$fstu_skills' WHERE stu_id=$id");
        }
        if ($res) {
            header('Location: index.php');
        }
        echo "<div class='alert alert-success'>Student Is Updated</div>";
    } else {
        echo "<pre>";
        print_r($Error);
        echo "</pre>";
...
<body>
    <section>
        <div class="container">
            <h2 class="text-primary text-center">Update Student</h2>
            <form action="" method="post" class="form" enctype="multipart/form-data">
                <div class="my-2 validate">
                    <label for="id" class="form-label">ID :</label>
                    <input type="text" name="stu_id" id="id" class="form-control" value="<?php echo $stu_id1 ?>">
                    <?php
                ...
                <div class="my-2 ">
                    ...
                    <input type="text" name="stu_name" id="name" class="form-control" value="<?php echo $stu_name1 ?>">
                    <?php
                ...
                <div class="my-2 ">
                    ...
                    <input type="text" name="stu_email" id="email" class="form-control" value="<?php echo $stu_email1 ?>">
                    <?php
                ...
                <div class="my-2 ">
                    ...
                    <input type="tel" name="stu_phone" id="phone" class="form-control" value="<?php echo $stu_phone1 ?>">
                </div>
                <div class="my-2">
                ...
                <div class="my-2">
                    ...
                    <select class="form-select" name="stu_depart">
                        ...
                        ?>
                            <option value="<?php echo $depart['stu_depart'] ?>" <?php echo  $depart['stu_depart'] == $stu_depart1 ? 'selected' : ''; ?>>
                ...
                <div class="my-2">
                    ...
                    ?>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="stu_skills[]" id="<?php echo $skill['skill_num'] ?>" value="<?php echo $skill['skill_name'] ?>" <?php echo  in_array($skill['skill_name'], $stu_skills1) ? 'checked' : ''; ?>>
                ...
                <div class="py-3">
                    <input type="submit" name="updateStu" value="Update" class="btn btn-primary col-12">
                </div>
            </form>
        </div>
    </section>
